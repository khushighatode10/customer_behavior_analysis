...
--Q3. Which are the top 5 products with the heighest avg review rating? [IMP Que]
...
--Q6. Which 5 products have the heighest percentage of purchases with discount applied?
...
--Q9. Are customers who are repeat buyers (more then 5 previous purchases) also likely to subscribe? [IMP Que]
select subscription_status,
